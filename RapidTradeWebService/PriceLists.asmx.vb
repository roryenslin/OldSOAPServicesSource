...
Public Class PriceLists
    ...
    Public Function ReadList(ByVal strSupplierId As String, ByVal strAccountId As String, _
        ...
        Return ReadListInclCatalogues(strSupplierId, strAccountId, strSearchString, strCategory, iOffset, iNoRows, bMyRange, False)
        ...
        Try
            If Not objReader Is Nothing AndAlso objReader.HasRows Then
                While (objReader.Read())
                    ...
                    objPriceLists(intCounter) = New PriceListInfo
