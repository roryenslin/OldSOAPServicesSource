...
Public Class Orders3
    ...
    Private orderToEmail As OrderInfo3
    ...
    Public Function Test(ByVal orderID As String, ByVal supplierID As String, ByVal userid As String, ByVal accountid As String, ByVal comments As String) As BaseResponse
        ...
        Dim line As New OrderItemInfo3
        ...
        line.Quantity = 1
        line.ItemID = 1
        order.OrderItems = New Generic.List(Of OrderItemInfo3)
    ...
    Public Function Modify(ByVal objOrderInfo3 As OrderInfo3) As BaseResponse
        ...
        Try
            ...
            'objOrderInfo3.CreateDate = Now
            If String.IsNullOrEmpty(objOrderInfo3.OrderID) Then objOrderInfo3.OrderID = Now.ToString("yyMMddhhmmss") & New Random().Next(50)

            cmdCommand.Parameters.AddWithValue("@OrderID", objOrderInfo3.OrderID)
            cmdCommand.Parameters.AddWithValue("@SupplierID", objOrderInfo3.SupplierID)
            cmdCommand.Parameters.AddWithValue("@UserID", objOrderInfo3.UserID)
            cmdCommand.Parameters.AddWithValue("@AccountID", objOrderInfo3.AccountID)
            cmdCommand.Parameters.AddWithValue("@BranchID", objOrderInfo3.BranchID)
            cmdCommand.Parameters.AddWithValue("@Status", objOrderInfo3.Status)
            'cmdCommand.Parameters.AddWithValue("@OrderNumber", objOrderInfo3.OrderNumber)
            cmdCommand.Parameters.AddWithValue("@CreateDate", Activities2.ConvertDate(objOrderInfo3.CreateDate))
            cmdCommand.Parameters.AddWithValue("@RequiredByDate", Activities2.ConvertDate(objOrderInfo3.RequiredByDate))
            cmdCommand.Parameters.AddWithValue("@Reference", objOrderInfo3.Reference)
            cmdCommand.Parameters.AddWithValue("@DeliveryMethod", objOrderInfo3.DeliveryMethod)
            cmdCommand.Parameters.AddWithValue("@Comments", objOrderInfo3.Comments)
            cmdCommand.Parameters.AddWithValue("@Type", objOrderInfo3.Type)
            cmdCommand.Parameters.AddWithValue("@DeliveryName", objOrderInfo3.DeliveryName)
            cmdCommand.Parameters.AddWithValue("@UserField01", objOrderInfo3.UserField01)
            cmdCommand.Parameters.AddWithValue("@UserField02", objOrderInfo3.UserField02)
            cmdCommand.Parameters.AddWithValue("@UserField03", objOrderInfo3.UserField03)
            cmdCommand.Parameters.AddWithValue("@UserField04", objOrderInfo3.UserField04)
            cmdCommand.Parameters.AddWithValue("@UserField05", objOrderInfo3.UserField05)
            cmdCommand.Parameters.AddWithValue("@UserField06", objOrderInfo3.UserField06)
            cmdCommand.Parameters.AddWithValue("@UserField07", objOrderInfo3.UserField07)
            cmdCommand.Parameters.AddWithValue("@UserField08", objOrderInfo3.UserField08)
            cmdCommand.Parameters.AddWithValue("@UserField09", objOrderInfo3.UserField09)
            cmdCommand.Parameters.AddWithValue("@UserField10", objOrderInfo3.UserField10)
            cmdCommand.Parameters.AddWithValue("@DeliveryAddress1", objOrderInfo3.DeliveryAddress1)
            cmdCommand.Parameters.AddWithValue("@DeliveryAddress2", objOrderInfo3.DeliveryAddress2)
            cmdCommand.Parameters.AddWithValue("@DeliveryAddress3", objOrderInfo3.DeliveryAddress3)
            cmdCommand.Parameters.AddWithValue("@DeliveryPostCode", objOrderInfo3.DeliveryPostCode)
            cmdCommand.Parameters.AddWithValue("@PostedToERP", objOrderInfo3.PostedToERP)
            cmdCommand.Parameters.AddWithValue("@ERPOrderNumber", objOrderInfo3.ERPOrderNumber)
            cmdCommand.Parameters.AddWithValue("@ERPStatus", objOrderInfo3.ERPStatus)
                ...
                For Each objOrderItem As OrderItemInfo3 In objOrderInfo3.OrderItems
                    ...
                    If String.IsNullOrEmpty(objOrderItem.Description) Then
                        Try
                            ...
                            cmdCommand3.Parameters.AddWithValue("@SupplierID", objOrderInfo3.SupplierID)
                    ...
                    cmdCommand1.Parameters.AddWithValue("@OrderID", objOrderInfo3.OrderID)
                    cmdCommand1.Parameters.AddWithValue("@AccountID", objOrderInfo3.AccountID)
                    cmdCommand1.Parameters.AddWithValue("@SupplierID", objOrderInfo3.SupplierID)
            ...
            Else
                ...
                If mustEmail(objOrderInfo3.SupplierID, objOrderInfo3.UserID) Then
                    orderToEmail = objOrderInfo3
                    createEmailOrder()
                End If
            End If
    ...
    <WebMethod()> _
    Public Function ReadList(ByVal strSupplierId As String, ByVal strUserId As String) As OrderReadListResponse3
        ...
        Try
            ...
            objOrderInfo3 = ReadOrders(objDBHelper.ExecuteReader(cmdCommand))
            objResponse.Status = True
            If Not objOrderInfo3 Is Nothing AndAlso objOrderInfo3.GetUpperBound(0) >= 0 Then
                objResponse.Orders = objOrderInfo3
            End If
        Catch ex As Exception
    ...
    Private Function ReadOrders(ByVal objReader As SqlDataReader) As OrderInfo3()
        Dim objOrders As OrderInfo3() = Nothing
        Dim intCounter As Integer = 0

        Dim objHash As New Hashtable
        Dim strFormTypeKey As String
        Dim objTempOrder As OrderInfo3 = Nothing
        Dim objTempOrderItem As OrderItemInfo3 = Nothing
        ...
        Try
            ...
            If Not objReader Is Nothing AndAlso objReader.HasRows Then
                While (objReader.Read())
                    ...
                    objOrders(intCounter) = New OrderInfo3
                    ...
                    While (objReader.Read())
                        ...
                        If objHash.ContainsKey(strFormTypeKey) Then
                            ...
                            If objTempOrder.OrderItems Is Nothing OrElse objTempOrder.OrderItems.Count = 0 Then
                                objTempOrder.OrderItems = New List(Of OrderItemInfo3)
                            End If
                            objTempOrderItem = New OrderItemInfo3
