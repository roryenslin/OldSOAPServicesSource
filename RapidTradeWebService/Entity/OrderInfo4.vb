...
Namespace Entity
    ...
    Public Class OrderInfo4
        ...
        Private _RequiredByDate As String
        ...
        Private _OrderItems As List(Of OrderItemInfo4)
        ...
        Public Sub New(ByVal strOrderID As String, ByVal strSupplierID As String, ByVal strUserID As String, ByVal strAccountID As String, ByVal strBranchID As String, _
                       ByVal strStatus As String, ByVal strOrderNumber As String, ByVal dtCreateDate As String, ByVal dtRequiredByDate As String, _
        ...
        Public Property UserField10() As String
            ...
            End Set
        End Property
        Public Property OrderItems() As List(Of OrderItemInfo4)
            Get
                Return _OrderItems
            End Get
            Set(ByVal value As List(Of OrderItemInfo4))
                _OrderItems = value
            End Set
        End Property
