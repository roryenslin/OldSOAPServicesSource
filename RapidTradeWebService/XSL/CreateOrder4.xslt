              ...
              <table border="0" cellpadding="0" cellspacing="0" width="800" bgcolor="#FFF" style="padding:10px;background:#FFF;">
                ...
                <tr>
                  <td style="text-align:left;font-family:Geneva,Verdana,Arial,Helvetica,sans-serif;font-size:10pt;color:black;vertical-align:top;">
                    <b>Ordered By:</b>
                    <br>
                      Account:<xsl:value-of select="OrderInfo4/AccountID"/>
                    </br>
                    
                  <br></br>
                  <br>Name: <xsl:value-of select="OrderInfo4/DeliveryName"/>                </br>
                  <br>Address: </br><br><xsl:value-of select="OrderInfo4/DeliveryAddress1"/></br>
                  <br><xsl:value-of select="OrderInfo4/DeliveryAddress2"/></br>
                    <br>
                     Email:   <xsl:value-of select="OrderInfo4/DeliveryAddress3"/>
                    </br>
                    <br>
                      Telephone: <xsl:value-of select="OrderInfo4/DeliveryPostCode"/>
                    </br>
                  <br></br>
                  </td>
                  <td>
                    <p style="text-align:left;font-family:Geneva,Verdana,Arial,Helvetica,sans-serif;color:black;vertical-align:top;font-size:8pt;margin:0 0 20px 0;">
                      Order Number: <xsl:value-of select="OrderInfo4/OrderID"/>
                      <br>
                        Order Date: <xsl:value-of select="OrderInfo4/CreateDate"/>
                      </br>
                      <br>
                        Reference: <xsl:value-of select="OrderInfo4/Reference"/>
                      </br>
                    </p>
                    <p style="text-align:left;font-family:Geneva,Verdana,Arial,Helvetica,sans-serif;color:black;vertical-align:top;font-size:10pt;">
                      <b>Required Date: </b>
                      <xsl:value-of select="OrderInfo4/RequiredByDate"/>
                    </p>
                  </td>
                </tr>
                <tr>
                  <td>
                    <p style="text-align:left;font-family:Geneva,Verdana,Arial,Helvetica,sans-serif;color:black;vertical-align:top;font-size:10pt;margin:20px 0 20px 0;">
                      <b>Comment:</b>
                      <br>
                        <xsl:value-of select="OrderInfo4/Comments"/>
                      </br>
                    </p>
                  </td>
                </tr>
                <tr>
                  <td colspan="2">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                      ...
                      <xsl:for-each select="OrderInfo4/OrderItems/OrderItemInfo4">
                        <tr>
