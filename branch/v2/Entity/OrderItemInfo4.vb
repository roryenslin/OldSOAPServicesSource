...
Namespace Entity
    ...
    Public Class OrderItemInfo4
        ...
        Private _RepNett As Double
        Private _RepDiscount As Double
        Private _RepChangedPrice As Boolean
        ...
        Public Sub New(ByVal strSupplierID As String, ByVal strOrderID As String, ByVal intItemId As Integer, ByVal strProductId As String, ByVal strWareHouse As String, ByVal description As String, _
                       ...
                       ByVal dDiscount As Double, ByVal dValueUnit As Double, ByVal dValue As Double, ByVal repNett As Double, ByVal repDiscount As Double, ByVal repChangedPrice As Boolean)
            _OrderID = strOrderID
            ...
            _RepChangedPrice = repChangedPrice
            _RepDiscount = repDiscount
            _RepNett = repNett
        End Sub
        ...
        Public Property Value() As Double
            ...
            End Set
        End Property
        Public Property RepNett() As Double
            Get
                Return _RepNett
            End Get
            Set(ByVal value As Double)
            ...
            End Set
        End Property
        Public Property RepDiscount() As Double
            Get
                Return _RepDiscount
            End Get
            Set(ByVal value As Double)
            ...
            End Set
        End Property
        Public Property RepChangedPrice() As Boolean
            Get
                Return _RepChangedPrice
            End Get
            Set(ByVal value As Boolean)
                _RepChangedPrice = value
            End Set
        End Property
    End Class
End Namespace