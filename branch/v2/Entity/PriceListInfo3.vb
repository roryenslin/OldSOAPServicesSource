...
Namespace Entity
    ...
    Public Class PriceListInfo3
        ...
        Public Sub New(ByVal strSupplierid As String, ByVal strProductID As String, ByVal strDescription As String, ByVal dVAT As Double, _
                       ...
                       ByVal strPriceList As String, ByRef dNett As Double, _
                       ByVal dGross As Double, ByVal dDiscount As Double, ByVal dCost As Double)
